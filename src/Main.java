public class Main {
    ...
    public static void checkingYear(int yearCheck) {
    ...
    public static void applicationSelection(int clientOS, int currentYear) {
    ...
    public static void task2() {
        ...
        applicationSelection(clientOS, currentYear);
